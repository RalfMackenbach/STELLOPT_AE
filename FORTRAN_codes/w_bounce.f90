...
subroutine w_bounce(q0,b_arr,dbdx_arr,dbdy_arr,sqrtg_arr,theta_arr,lam, &
  ...
  real(kind=8), intent(in)                :: q0, lam,Delta_x,Delta_y
  real(kind=8)                            :: L_tot
  ...
  call trapz(theta_arr,q0 * b_arr * sqrtg_arr,size(theta_arr),L_tot)
