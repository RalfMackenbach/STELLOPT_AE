...
class gist_sim:
    ...
    def __init__(self, filename='GIST.txt'):
        ...
        try:
            ...
            print("s0,alpha         not found in txt file, so not assigned to class")
            pass
        ...
        try:
            ...
            print("major/minor r    not found in txt file, so not assigned to class")
            pass
        ...
        try:
            ...
            print("B_arr            not found in txt file, so not assigned to self")
            pass
        ...
        try:
            ...
            print("my_dpdx          not found in txt file, so not assigned to self")
            pass
...
class GENE_geom:
    """
    Class that accesses the GENE geometry data in a more pythonic way.
    Invoke an element of the class as follows:
    GENE_geom = G_functions.GENE_geom(filename='.../GENE_gist.txt')
    This creates a GENE_geom object. This object has various attributes:
    GENE_geom.
    - txt_file          : the entire txt file
    ...
    def __init__(self, filename):
        ...
        try:
            ...
            print("s0       not found in txt file, so not assigned to self")
            pass
        ...
        try:
            ...
            print("r0       not found in txt file, so not assigned to self")
            pass
        ...
        try:
            ...
            print("trpeps   not found in txt file, so not assigned to self")
            pass
        ...
        try:
            ...
            print("beta     not found in txt file, so not assigned to self")
            pass
        ...
        try:
            ...
            print("Bref     not found in txt file, so not assigned to self")
            pass
        ...
        # Calculate normalized arclength
        B_norm          = self.functions[:, 6]
        jac             = self.functions[:,10]
        integrand       = np.asarray((B_norm)/jac)
        # Straightforward cumtrapz for integral
        l_arr           = cumtrapz(integrand,self.z_coord,initial=0)
        # Set z=0 => l=0
